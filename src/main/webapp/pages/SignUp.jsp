...
<div class="container">
  <form class="form-signin">
    ...
    <input type="password" id="inputPassword" class="form-control" placeholder="<fmt:message key="signin.password"/>"
           required="">
    <input type="text" id="inputFirstName" class="form-control" placeholder="<fmt:message key="signup.firstname"/> ">
    <input type="text" id="inputLastName" class="form-control" placeholder="<fmt:message key="signup.lastname"/> ">
    <div class="checkbox">
